...
triggers: ["cross verify rfp", "independent review", "second opinion review"]
---
...
6. **Emit telemetry.**
   ...
   tel_emit cross-verify complete "{\"reviewers\": [\"claude-subagent\"${CODEX_PRESENT}], \"hallucinations\": ${H}, \"speculative\": ${S}, \"unanswered\": ${U}, \"weasel\": ${W}}"
   ```
