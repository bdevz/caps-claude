...
triggers: ["review the rfp", "qa the draft", "internal review"]
---
...
10. **Emit telemetry.**
    ...
    tel_emit reviewer complete "{\"status\": \"${STATUS}\", \"coverage_gaps\": ${COV}, \"consistency_issues\": ${CONS}, \"citation_issues\": ${CIT}, \"spelling_fixes\": ${SP}}"
    ```
