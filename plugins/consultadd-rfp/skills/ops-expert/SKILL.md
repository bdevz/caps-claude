...
2. **Read knowledge sources.**
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/capabilities.md` — PM methodology section, cross-cutting capabilities
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/past-wins/*.md` — case studies for ops credibility (delivered on schedule, under budget, etc.)
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/key-personnel/*.md` — bios for PM, technical leads, deputy PMs
