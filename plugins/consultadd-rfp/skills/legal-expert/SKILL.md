...
2. **Read knowledge sources.**
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/compliance/standard-msa-terms.md` — approved MSA boilerplate
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/compliance/attestations/*.md` — one per common attestation
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/compliance/data-handling.md` — data security language
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/compliance/subcontracting-plan.md` — small-business subcontracting plan template
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/certifications.md` — Insurance + Security Clearances sections
