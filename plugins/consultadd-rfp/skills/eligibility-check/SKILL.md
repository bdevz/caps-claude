...
1. **Read sources.**
   ...
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/certifications.md`
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/capabilities.md`
   - `${CLAUDE_PLUGIN_ROOT}/skills/_shared/knowledge/past-wins/*.md` (for past-performance threshold matching)
